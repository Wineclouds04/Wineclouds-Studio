namespace WinecloudsStudio.Modules.WindowManager.Services.Interop;

/// <summary>
/// Win32 constants for window styles, messages, and commands.
/// Directly ported from EVE-O-Preview reference project.
/// </summary>
